...
const UNLOCKED_ACCOUNT = '0x2291F52bddc937b5B840d15E551e1DA8C80c2B3c' // Sishu account to impersonate 
const AMOUNT = '2' //  Sishu -- Tokens will automatically be converted to wei
...
async function main() {
  ...
  const data = {
    'Price Before': `1 WETH = ${Number(priceBefore).toFixed(0)} Sishu`,
    'Price After': `1 WETH = ${Number(priceAfter).toFixed(0)} Sishu`,
  }
